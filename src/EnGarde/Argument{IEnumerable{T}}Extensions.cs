...
namespace EnGarde
{
    public static partial class ArgumentExtensions
    {
        ...
        /// <param name="value">The object to locate in the <see cref="IEnumerable{T}"/>.</param>
        ...
        [DebuggerStepThrough]
        public static IValidatedArgument<IEnumerable<T>> Contains<T>(this IArgument<IEnumerable<T>> argument, T value, string message = null)
        {
            if (argument == null)
            {
        ...
        internal static bool ValidateContains<T>(IArgument<IEnumerable<T>> argument, T value, string message, out Exception exception)
        {
        ...
        internal static bool ValidateIsEmpty<T>(IArgument<IEnumerable<T>> argument, string message, out Exception exception)
        {
